...
function t331_initPopup(recId) {
  ...
  var currentHook = currentBlock
    ? currentBlock.getAttribute("data-tooltip-hook")
    : "";
  var currentAnalitics = currentBlock
    ? currentBlock.getAttribute("data-track-popup")
    : "";
...
function t331_setHeight(recid) {
  ...
  var videoWidth = videoCarrier
    ? videoCarrier.getAttribute("data-video-width")
    : "0";
  var videoHeight = videoCarrier
    ? videoCarrier.getAttribute("data-video-height")
    : "0";
...
function t331_showPopup(recid) {
  ...
  var videoID = videoContainer
    ? videoContainer.getAttribute("data-content-popup-video-url-youtube")
    : "";
  if (videoID) videoID = videoID.replace("https://www.youtube.com/shorts/", "");
  ...
  setTimeout(function () {
    var popupContainer = popup
      ? popup.querySelector(".t-popup__container")
      : null;
    if (popupContainer)
