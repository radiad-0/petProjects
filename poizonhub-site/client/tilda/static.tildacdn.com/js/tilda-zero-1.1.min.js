function t396_init(t) {
  ...
  d &&
    ...
    (window.tn_scale_factor = parseFloat(
      (window.tn_window_width / n).toFixed(3)
    )),
    ...
    window.addEventListener("resize", function () {
      tn_console(">>>> t396: Window on Resize event >>>>"),
        ...
        d && d.classList.contains("t396_fullscreenchange")
          ? d.classList.remove("t396_fullscreenchange")
          : t396_waitForFinalEvent(
              function () {
                ((!window.t396__isMobile && !i) ||
                  document.documentElement.clientWidth !==
                    window.tn_window_width) &&
                  (t396_doResize(t), d.classList.remove("t396_resizechange"));
              },
              500,
              "resizeruniqueid" + t
            );
    ...
    (o = !!document.querySelector(".t635__textholder")),
    a &&
      o &&
      r &&
      d &&
    ...
    o &&
      r &&
      d &&
      ((o = d.getAttribute("data-artboard-ovrflw")),
      (r.style.position = "relative"),
      (r.style.zIndex = "auto" === o || "visible" === o ? "2" : "1")));
}
...
function t396_doResize(t) {
  ...
  t396_removeElementFromDOM(i ? i.querySelector(".t396__scale-style") : null),
    e
      ...
      : ((a = i ? i.querySelectorAll(".t396__elem") : []),
...
function t396_updateTNobj(t) {
  ...
  var e = "ab" + t,
    ...
    n = (i && window.getComputedStyle(i).paddingLeft) || "0",
    n = parseInt(n, 10),
    t = (i && window.getComputedStyle(i).paddingRight) || "0",
    t = parseInt(t, 10);
  window.zero_window_width_hook &&
  "allrecords" === window.zero_window_width_hook &&
  i
    ? (window.tn.window_width = i.clientWidth - (n + t))
  ...
  for (var o = window.tn[e].screens.slice().reverse(), a = 0; a < o.length; a++)
    window.tn[e].curResolution === o[a] &&
      ((window.tn[e].canvas_min_width = o[a]),
      (window.tn[e].canvas_max_width =
        0 === a ? window.tn.window_width : o[a - 1]));
  (window.tn[e].grid_width = window.tn[e].canvas_min_width),
    (window.tn[e].grid_offset_left =
      (window.tn.window_width - window.tn[e].grid_width) / 2);
}
...
function t396_switchResolution(t, e) {
  ...
  (window.tn[i].curResolution = e),
    (window.tn[i].curResolution_max = t),
    (window.tn.curResolution = e),
    (window.tn.curResolution_max = t);
}
function t396_artboard_build(t, e) {
  ...
  Array.prototype.forEach.call(t, function (t) {
    ...
    o.dispatchEvent(a);
  var r,
    a = o.getAttribute("data-artboard-ovrflw");
  ("visible" !== a && "visibleX" !== a) || !n || (n.style.overflow = "hidden"),
    "auto" !== a ||
...
function t396_ab__renderView(t) {
  ...
  if (
    (_ && !l && i && (o = parseInt(r, 10) * window.tn_scale_factor),
    r === d || (o && d <= o))
  )
    a = 0;
  else
    switch (t396_ab__getFieldValue(t, "valign")) {
      ...
      case "center":
        a = o
          ? parseFloat(((d - o) / 2).toFixed(1))
          : parseFloat(((d - r) / 2).toFixed(1));
        break;
      case "bottom":
  ...
  t.setAttribute("data-artboard-proxy-min-offset-top", a),
    ...
    t.setAttribute("data-artboard-proxy-max-height", d);
  (_ = t.querySelector(".t396__filter")),
    (l = t.querySelector(".t396__carrier"));
  (i = t396_ab__getFieldValue(t, "height_vh")),
    (i = parseFloat(i)),
    window.t396__isMobile &&
      i &&
      ((i = (document.documentElement.clientHeight * i) / 100),
      (t.style.height = i + "px"),
      _ && (_.style.height = i + "px"),
...
function t396_addShape(t, e) {
  ...
  (e = t396_getEl(e)) &&
    ...
    (a = "width,height,top,left,"),
    (a += "container,axisx,axisy,widthunits,heightunits,leftunits,topunits"),
    e.setAttribute(
      "data-fields",
    ...
    i &&
      a &&
      a.transform &&
      (o = "matrix" === a.transform.substring(0, 6) ? a.transform : null),
    o && n && ((i.style.transform = "none"), (e.style.transform = o)));
}
...
function t396_addForm(t, e, i) {
  ...
  (e = t396_getEl(e)) &&
    ...
    (a = "width,top,left,"),
    (a += "inputs,container,axisx,axisy,widthunits,leftunits,topunits"),
    e.setAttribute(
      "data-fields",
...
function t396_elem__setFieldValue(t, e, i, n, o, a) {
  ...
  (t = t396_getEl(t)) &&
    ...
    +(a = a || window.tn[r].curResolution) < window.tn[r].curResolution_max &&
    "zindex" !== e
      ...
      for (var l = 0; l < d.length; l++) {
        ...
        if (
          ...
          ((dataField =
            _ === r
              ? t.getAttribute("data-field-" + e + "-value")
              : t.getAttribute("data-field-" + e + "-res-" + _ + "-value")),
          dataField)
        )
          break;
      }
...
function t396_elem__renderViewOneField(t, e) {
  if (((t = t396_getEl(t)), t && "yes" !== t.getAttribute("data-scale-off"))) {
    var i,
      n,
      o,
      a,
      r,
      d = t396_elem__getFieldValue(t, e);
    switch (e) {
      case "left":
        (d = t396_elem__convertPosition__Local__toAbsolute(t, e, d)),
          (t.style.left = parseFloat(d).toFixed(1) + "px");
        break;
      case "top":
        (d = t396_elem__convertPosition__Local__toAbsolute(t, e, d)),
          (t.style.top = parseFloat(d).toFixed(1) + "px");
        break;
      case "width":
        switch (
          ((d = t396_elem__getWidth(t, d)),
          (t.style.width = parseFloat(d).toFixed(1) + "px"),
          (_ = t.getAttribute("data-elem-type")))
        ) {
          case "tooltip":
            var l = t.querySelectorAll(".tn-atom__pin-icon");
            Array.prototype.forEach.call(l, function (t) {
              var e = parseFloat(d).toFixed(1) + "px";
              (t.style.width = e), (t.style.height = e);
            }),
              (t.style.height = parseInt(d).toFixed(1) + "px");
            break;
          case "gallery":
      ...
      case "height":
        ...
        (d = t396_elem__getHeight(t, d)),
          (t.style.height = parseFloat(d).toFixed(1) + "px"),
          "gallery" === _ &&
            ((i = t396_elem__getFieldValue(t, "borderwidth")),
            ((n = t396_elem__getFieldValue(t, "borderstyle")) &&
              i &&
...
function t396_elem__convertPosition__Local__toAbsolute(t, e, i) {
  if ((t = t396_getEl(t))) {
    ...
    switch (((i = parseInt(i)), e)) {
      case "left":
        var h = "grid" === g ? "grid" : "window",
          f = "grid" === g ? window.tn[a].grid_offset_left : 0,
          m = "grid" === g ? window.tn[a].grid_width : window.tn.window_width;
        "%" === t396_elem__getFieldValue(t, "leftunits") &&
          (i = t396_roundFloat((m * i) / 100)),
          !l && d
            ? "grid" === g && _ && (i *= window.tn_scale_factor)
            : (i = f + i),
          "center" === w &&
            ((F = t396_elem__getWidth(t)),
            s &&
              "window" !== h &&
              ((m *= window.tn_scale_factor), (F *= window.tn_scale_factor)),
            (i = m / 2 - F / 2 + i)),
          "right" === w &&
            ((F = t396_elem__getWidth(t)),
            s &&
          ...
          s &&
            "window" !== h &&
            (i +=
              ((F = t396_elem__getWidth(t)) * window.tn_scale_factor - F) / 2);
        break;
      case "top":
        var p = t.parentNode;
        p.classList.contains("t396__artboard") || (p = p.parentNode);
        var b = p ? p.getAttribute("data-artboard-proxy-min-offset-top") : "0",
          y = p ? p.getAttribute("data-artboard-proxy-min-height") : "0",
          f = p ? p.getAttribute("data-artboard-proxy-max-height") : "0",
          m = function (t) {
            var e,
              i,
        ...
        (h = "grid" === g ? "grid" : "window"),
          (F = "grid" === g ? parseFloat(b) : 0),
          (b = "grid" === g ? parseFloat(y) : parseFloat(f)),
          "%" === t396_elem__getFieldValue(t, "topunits") &&
            (i = b * (i / 100)),
          s && "window" !== h && (i *= window.tn_scale_factor),
          c &&
            "window" !== h &&
            (F = "stretch" === r ? 0 : F / window.tn_scale_factor),
          (i = F + i);
        var v,
          y = t396_ab__getFieldValue(p, "height_vh"),
          f = t396_ab__getFieldValue(p, "height"),
          F = t396_ab__getHeight(p);
        d && !l && y && (v = parseInt(f, 10) * window.tn_scale_factor),
          "center" === u &&
            ((n = m(t)),
            s &&
              "window" !== h &&
...
function t396_ab__setFieldValue(t, e, i, n) {
  ...
  (n = n || window.tn[o].curResolution) < window.tn[o].curResolution_max && t
...
function t396_ab__filterUpdate(t) {
  ...
  o &&
    ((e = o.getAttribute("data-filtercolor-rgb")),
    (i = o.getAttribute("data-filtercolor2-rgb")),
    (n = o.getAttribute("data-filteropacity")),
    (t = o.getAttribute("data-filteropacity2")),
    e && !i
      ? (o.style.backgroundColor = "rgba(" + e + "," + n + ")")
      : !e && i
      ? (o.style.backgroundColor = "rgba(" + i + "," + t + ")")
      : e && i
      ? (o.style.background =
