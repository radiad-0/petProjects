function t_zeroForms__init(recid, elemid, formObjectEls) {
    var rec = document.getElementById("rec" + recid),
        zeroForm = rec
            ? rec.querySelector('.tn-elem[data-elem-id="' + elemid + '"]')
            : null;
    if (zeroForm) {
        ...
        t_zeroForms__waitForTN(function () {
            ...
            t_zeroForms__onFuncLoad("t396_elem__renderViewOneField", function () {
                t396_elem__renderViewOneField(
                    isOldPage ? $(zeroForm) : zeroForm,
                    "left"
                ),
                    t396_elem__renderViewOneField(
                        isOldPage ? $(zeroForm) : zeroForm,
...
function t_zeroForms__renderForm(zeroForm, formObjectEls, recid, tildamode) {
    if (
        ...
        "edit" === window.tildamode ||
        (recid = zeroForm.closest(".r").id.replace("rec", "")),
        "string" == typeof formObjectEls)
    )
        try {
    ...
    var record = document.querySelector(".t-records"),
        ...
        rec;
    if (
        (isEditMode || (isEditMode = "published" !== window.tildamode),
        !zeroForm.classList.contains("zero-form-rendered") || isEditMode) &&
        ((!t_zeroForms__isRecordHidden(zeroForm.closest(".r")) &&
                !t_zeroForms__isFormOutside(zeroForm)) ||
        ...
        if ("zero" === window.tildamode || "edit" === window.tildamode)
            zeroFormAtom.innerHTML = "";
        else if (zeroFormAtom.querySelector(".t-form")) return;
        var form = t_zeroForms__createForm(
            recid,
            tildamode,
            arrayOfElements,
            zeroForm
        ...
        if (form) {
            ...
            customElEvent.initEvent("render", !0, !0),
    ...
    t_zeroForms__onRender(form, !0, function () {
        ...
        t_zeroForms__onFuncLoad("tildaForm_initMasks", function () {
            setTimeout(function () {
                ...
                form.querySelector(
                    '.js-tilda-mask:not([data-tilda-mask-init="1"])'
                ) && tildaForm_initMasks();
            }, 500);
        });
    });
...
function t_zeroForms__createForm(recid, tildamode, arrayOfElements, zeroForm) {
    ...
    if (
        (form.classList.add("t-form"),
            form.classList.add(
                "t-form_inputs-total_" + arrayOfElsWithoutHiddenFiels.length
            ),
        ...
        form.setAttribute("data-success-url", formObj.formmsgurl)),
            (formObj.receivers ? formObj.receivers.split(",") : []).forEach(function (
                receiverValue
            ) {
                var hiddenInput = t_zeroForms__createHiddenField(
                    receiverValue,
                    "formservices[]",
        ...
        var formNameInput = t_zeroForms__createHiddenField(
            formObj.formname,
            "tildaspec-formname",
            ""
        );
    ...
    var titleStyles = {
        ...
        inputsBlock = t_zeroForms__generateInputsBlock(
            recid,
            zeroForm,
            arrayOfElements,
            formObj,
    ...
    if (formObj.formbottomtext) {
        ...
        (bottomText.style.textAlign =
            "center" === formObj.buttonalign ? "center" : "left"),
        ...
        var bottomBLock = t_zeroForms__getBottomText(
            formID,
            formObj,
            recid,
            zeroForm
    ...
    if (
        (form.insertAdjacentElement(
            "beforeend",
            t_zeroForms__createErrorBox(formObj, "bottom")
        ),
        ...
        var multiLandingBlocks = document.querySelectorAll(
            '[data-record-type="803"]'
        );
        Array.prototype.forEach.call(
            multiLandingBlocks,
            function (multiLandingBlock) {
...
function t_zeroForms__updateStylesOnResize(recid, zeroForm) {
    var formObj = t_zeroForms__createFormObj(zeroForm),
        ...
        inputFontWeight =
            "variation" === formObj.inputfontweight
                ? formObj.inputvariationweight
                : formObj.inputfontweight,
    ...
    Array.prototype.forEach.call(phoneMaskInputs, function (phoneMaskInput) {
        ...
        "h" === formObj.inputpos
            ? formEl && formEl.classList.add("tn-form_horiz")
    ...
    var titleStyles = {
        ...
        titleFontWeight =
            "variation" === formObj.inputtitlefontweight
                ? formObj.inputtitlevariationweight
                : formObj.inputtitlefontweight,
    ...
    var inputGroup = zeroForm.querySelectorAll(".t-input-group"),
        inputPosStyles = formObj.inputmargbottom
            ? "margin-bottom:" + formObj.inputmargbottom + "px;"
            : "";
    (inputPosStyles +=
        formObj.inputmargright && "h" === formObj.inputpos
            ? "padding-right:" + formObj.inputmargright + "px;"
            : "") &&
    ...
    if (submitBtn) {
        t_zeroForms__setBtnInlineStyles(formObj, submitBtn),
            t_zeroForms__generateBtnStyles(
                submitBtn,
                recid,
                formID,
                formObj,
    ...
    return (
        inputsBlock.classList.add("t-form__inputsbox"),
            filteredArrayOfEls.forEach(function (elementObj) {
                var parsedHTMLElement = t_zeroForms__parseIntoElement(
                    recid,
                    zeroForm,
                    elementObj,
                    formObj,
                ...
                parsedHTMLElement &&
                inputsBlock.insertAdjacentElement("beforeend", parsedHTMLElement);
            }),
            inputsBlock.insertAdjacentElement(
                "beforeend",
                t_zeroForms__createErrorBox(formObj, "middle")
            ),
            inputsBlock.insertAdjacentElement(
                "beforeend",
                t_zeroForms__createFormButton(recid, zeroForm, formID, formObj)
            ),
            inputsBlock
    );
}

function t_zeroForms__parseIntoElement(
    recid,
    zeroForm,
    elementObj,
    formObj,
    ...
    recid ||
    (recid = (recid = zeroForm.closest(".r")
        ? zeroForm.closest(".r").id
        : "").replace("rec", ""));
    var inputPosStyles = formObj.inputmargbottom
        ? "margin-bottom:" + formObj.inputmargbottom + "px;"
        : "";
    inputPosStyles +=
        formObj.inputmargright && "h" === formObj.inputpos
    ...
    inputPosStyles && (inputGroup.style = inputPosStyles);
    var inputFontWeight =
            "variation" === formObj.inputfontweight
                ? formObj.inputvariationweight
                : formObj.inputfontweight,
        textFontWeight =
            "variation" === formObj.inputelsfontweight
                ? formObj.inputelsvariationweight
                : formObj.inputelsfontweight,
        titleFontWeight =
            "variation" === formObj.inputtitlefontweight
                ? formObj.inputtitlevariationweight
                : formObj.inputtitlefontweight;
    elementObj.li_title &&
    t_zeroForms__generateTitle(
        elementObj,
        titleStyles,
        inputGroup,
        titleFontWeight
    ),
    elementObj.li_subtitle &&
    t_zeroForms__generateSubtitle(elementObj, titleStyles, inputGroup);
    var inputStyles = t_zeroForms__initInputStyles(formObj, inputFontWeight),
        labelStyles = {
    ...
    switch ((inputBlock.classList.add("t-input-block"), elementObj.li_type)) {
        case "em":
            generatedField = t_zeroForms__createInput(
                elementObj,
                inputStyles,
                inputPreferences,
                "email"
            ...
            break;
        case "ph":
            (generatedField = t_zeroForms__createPhoneInput(
                recid,
                elementObj,
                inputStyles,
                inputPreferences
        ...
        case "sb":
            if (
                ((generatedField = t_zeroForms__createSelect(
                    elementObj,
                    inputStyles,
                    inputPreferences
                )),
                ...
                var styles = document.createElement("style"),
                    selector = t_zeroForms__createSelector(
                        recid,
                        formID,
                        ".t-select__wrapper:after"
                    ),
                    selectorWrapperColor = formObj.inputsstyle
                        ? formObj.inputelscolor
                        : inputStyles.color;
                (styles.textContent =
                    selector + "{border-top-color:" + selectorWrapperColor + ";}"),
                    generatedField.insertAdjacentElement("beforeend", styles);
            }
            break;
        case "rd":
            generatedField = t_zeroForms__createRadio(
                elementObj,
                formObj,
                inputPreferences,
                labelStyles
            ...
            t_zeroForms__setIndicatorStyles(
                recid,
                formID,
                formObj.inputelscolor,
                inputType,
            ...
            "checkbox" === inputType &&
            t_zeroForms__onRender(zeroForm, !1, function () {
                var inputWrapper = zeroForm.querySelector(
                        '[data-input-lid="' + elementObj.lid + '"]'
                    ),
                    checkboxList;
                inputWrapper &&
                Array.prototype.slice
                    .call(inputWrapper.querySelectorAll(".t-checkbox"))
            ...
            break;
        case "ri":
            (generatedField = t_zeroForms__createRadioImage(
                elementObj,
                formObj,
                inputPreferences
            )),
            ...
            break;
        case "cb":
            (generatedField = t_zeroForms__createCheckbox(
                elementObj,
                labelStyles,
                formObj,
                inputPreferences
            ...
            break;
        case "uw":
            (generatedField = t_zeroForms__createUploadField(
                elementObj,
                inputPreferences,
                "uw"
            )),
        ...
        case "uc":
            ...
            break;
        case "da":
            (generatedField = t_zeroForms__createDateField(
                elementObj,
                inputPreferences,
                inputStyles,
                formObj
        ...
        case "tm":
            ...
            break;
        case "qn":
            (generatedField = t_zeroForms__createQuantityField(
                elementObj,
                inputStyles,
                formObj.inputelscolor,
                inputPreferences
            )),
                zeroForm.removeEventListener(
                    "click",
                    t_zeroForms__initQuanityClickCount
                ),
                zeroForm.addEventListener("click", t_zeroForms__initQuanityClickCount);
            break;
        case "rg":
            if (
                ((generatedField = t_zeroForms__createQuantityRange(
                    elementObj,
                    inputStyles,
                    formObj,
                    inputPreferences
                ...
                var rangeStyles = document.createElement("style"),
                    rangeSelector = t_zeroForms__createSelector(
                        recid,
                        formID,
                        ".t-range"
                    ),
        ...
        case "ws":
            ...
            elementObj.li_rows &&
            (generatedField.style.height = 34 * elementObj.li_rows + "px");
            break;
        case "fr":
            if (
                ((generatedField = t_zeroForms__createCalculation(
                    elementObj,
                    inputStyles,
                    inputPreferences,
                    titleStyles
                )),
                    formObj.inputfrbgcolor)
            ) {
                var calcStyles = document.createElement("style"),
                    calcSelector = t_zeroForms__createSelector(
                        recid,
                        formID,
                        ".t-input-group_fr"
                    );
...
function t_zeroForms__waitCalcFields(recid, elementObj, zeroForm) {
    var inputNameList = t_zeroForms__removeStringQuotes(elementObj.li_expr).match(
            /[A-z0-9_]+/gi
        ),
...
function t_zeroForms__generateSubtitle(elementObj, titleStyles, inputGroup) {
    var exceptTypes,
        ...
        text = document.createElement(
            elementObj.li_title || isExceptType ? "div" : "label"
        );
    "LABEL" === text.tagName && (text.style.display = "block"),
    "LABEL" === text.tagName &&
    text.setAttribute("for", elementObj.li_type + "-" + elementObj.lid),
...
function t_zeroForms__generateTitle(
    elementObj,
    titleStyles,
    inputGroup,
    titleFontWeight
    ...
    "LABEL" === title.tagName &&
    title.setAttribute("for", elementObj.li_type + "-" + elementObj.lid),
...
function t_zeroForms__createPhoneInput(
    recid,
    elementObj,
    inputStyles,
    inputPreferences
    ...
    if (
        (elementObj.li_title || elementObj.li_subtitle
            ...
            "a" === maskType
                ...
                : elementObj.li_mask && input.classList.add("js-tilda-mask"),
        "a" === maskType)
    ) {
        var browserLangCode =
        ...
        elementObj.li_maskcountry &&
        input.setAttribute(
            "data-phonemask-maskcountry",
            elementObj.li_maskcountry
        ),
        inputPreferences.secondaryClassName &&
        input.classList.add(inputPreferences.secondaryClassName),
        ...
        inputPreferences.mask &&
        input.setAttribute("data-tilda-mask", inputPreferences.mask);
    return t_zeroForms__appendStylesToField(input, inputStyles), input;
}

function t_zeroForms__createInput(
    elementObj,
    inputStyles,
    inputPreferences,
    type
    ...
    ("time" === type || ("oneline" === type && elementObj.li_mask)) &&
    input.classList.add("js-tilda-mask"),
    "oneline" === type &&
    (inputPreferences.rule &&
    input.setAttribute("data-tilda-rule", inputPreferences.rule),
    inputPreferences.mask &&
    input.setAttribute("data-tilda-mask", inputPreferences.mask)),
        t_zeroForms__appendAttributes(input, inputPreferences),
        t_zeroForms__appendStylesToField(input, inputStyles),
...
function t_zeroForms__setTextareaHeight(elementObj, textarea) {
    var textAreaRowHeight = 25,
        textAreaPadding = 10;
    elementObj.li_rows > 1 &&
    ((textarea.style.height = 25 * elementObj.li_rows + 10 + "px"),
...
function t_zeroForms__createSelect(elementObj, inputStyles, inputPreferences) {
    var options = elementObj.li_variants
            ? elementObj.li_variants.split("\n")
            : [],
        selectedOption = parseInt(elementObj.li_defselitem, 10),
        inputWrapper = document.createElement("div");
    inputWrapper.classList.add("t-select__wrapper"),
    inputPreferences.secondaryClassName &&
    inputWrapper.classList.add("t-select__wrapper_bbonly");
    ...
    if (
        ...
        inputPreferences.secondaryClassName &&
        input.classList.add("t-select_bbonly"),
        inputPreferences.require && input.setAttribute("data-tilda-req", "1"),
            t_zeroForms__appendStylesToField(input, inputStyles),
    ...
    return (
        options.forEach(function (option, i) {
            ...
            inputStyles &&
            inputStyles.color &&
            (optionEl.style.color = inputStyles.color),
...
function t_zeroForms__createRadio(
    elementObj,
    formObj,
    inputPreferences,
    labelStyles
) {
    var radioOptions = elementObj.li_variants
            ? elementObj.li_variants.split("\n")
            : [],
        ...
        wrapperClassName,
        wrapper = t_zeroForms__createWrapper(
            (isCheckbox ? "t-checkboxes" : "t-radio") + "__wrapper"
        );
    isCheckbox &&
    fragment.appendChild(
        t_zeroForms__createNameFieldForCheckbox(
            inputPreferences,
            wrapper,
            "checkboxes"
        )
    ...
    return (
        wrapper.insertAdjacentElement("beforeend", fieldSet),
            radioOptions.forEach(function (radioOption, i) {
                ...
                isCheckbox || (input.name = inputPreferences.name);
                ...
                var indicator = t_zeroForms__createIndicator(
                    inputType,
                    formObj.inputelscolor,
                    !1
                );
    ...
    if (galleryOptions) {
        ...
        var inputType = isCheckbox ? "checkbox" : "radio",
            ...
            imgRatioClass =
                ...
                (elementObj.li_imgratio
                    ? elementObj.li_imgratio.replace("_", "-")
                    : "1-1");
        return (
            arrayOfOptions.forEach(function (imgOption, i) {
                ...
                inputPreferences.require && input.setAttribute("data-tilda-req", "1"),
                    label.insertAdjacentElement("beforeend", input);
                var indicator = t_zeroForms__createIndicator("img-select", !1, {
                    ratio: imgRatioClass,
                    img: imgOption.img,
                });
                if (
                    ...
                    formObj.inputtitlecolor &&
                    (textElement.style.color = formObj.inputtitlecolor),
...
function t_zeroForms__createCheckbox(
    elementObj,
    labelStyles,
    formObj,
    inputPreferences
...
function t_zeroForms__createUploadField(elementObj, inputPreferences, type) {
    ...
    if ("published" !== window.tildamode) {
        ...
        return (
            (editorFileInput.textContent = isNeedKey
                ? "Please set the key"
                : "Upload button will be here"),
                editorFileInput
        );
    }
    var selector = isUpldWidget ? "t-upwidget" : "t-uploadcare",
        wrapper = t_zeroForms__createWrapper(selector),
        wrapperStyles = isUpldWidget
            ? "margin-bottom:5px;min-height:38px;"
            : "margin-bottom:10px;";
    ...
    return (
        t_zeroForms__appendMainSettingToField(
            ...
            input.setAttribute(
                "role",
                isUpldWidget ? "upwidget-uploader" : "uploadcare-uploader"
            ),
        inputPreferences.require && input.setAttribute("data-tilda-req", "1"),
            ...
            isUpldWidget
                ...
                "y" === elementObj.li_multiupl &&
                input.setAttribute("data-tilda-upwidget-multiple", "1"))
                : input.setAttribute(
                    "data-public-key",
                    elementObj.li_uckey || "demopublickey"
                ),
            wrapper.insertAdjacentElement("beforeend", input),
            t_zeroForms__setScriptOrStyle(
                selector + "-zero-form",
                isUpldWidget ? "tilda-upwidget-1.1.min.js" : "uploadcare-3.x.min.js",
                "",
                "script",
                !1
            ),
...
function t_zeroForms__createDateField(
    elementObj,
    inputPreferences,
    inputStyles,
    formObj
...
function t_zeroForms__createQuantityField(
    elementObj,
    inputStyles,
    color,
    inputPreferences
...
function t_zeroForms__createQuantityBtn(type, color) {
    ...
    return (
        ...
        color && (btn.style.color = color),
            (btn.innerHTML = "minus" === type ? "&ndash;" : "+"),
            btn
    );
}

function t_zeroForms__createQuantityRange(
    elementObj,
    inputStyles,
    formObj,
    inputPreferences
    ...
    formObj.inputelscolor &&
    input.setAttribute("data-range-color", formObj.inputelscolor),
    ...
    var minValueField = t_zeroForms__createRangeField(
            "min",
            formObj.inputtitlecolor,
            elementObj.li_vmin || "0"
        ),
        maxValueField = t_zeroForms__createRangeField(
            "max",
            formObj.inputtitlecolor,
            elementObj.li_vmax || "10"
        );
    return (
...
function t_zeroForms__createCalculation(
    elementObj,
    inputStyles,
    inputPreferences,
    titleStyles
    ...
    var wrapper = t_zeroForms__createWrapper([
        "t-calc__wrapper",
        "t-name",
        "t-name_md",
    ]);
    ...
    if (
        (valueField.classList.add("t-calc"),
            valueField.setAttribute(
                "data-calc-expr",
                t_zeroForms__removeStringQuotes(elementObj.li_expr)
            ),
    ...
    if (elementObj.li_prod_title) {
        var titleInput = t_zeroForms__createHiddenField(
            elementObj.li_prod_title,
            "prod_title",
    ...
    if (elementObj.li_prod_img) {
        var productIMG = t_zeroForms__createHiddenField(
            elementObj.li_prod_img,
            "prod_img",
...
function t_zeroForms__setBtnInlineStyles(formObj, btn) {
    var btnFontWeight =
        "variation" === formObj.buttonfontweight
            ? formObj.buttonvariationweight
            : formObj.buttonfontweight;
    ...
    (btn.style.boxShadow =
        ...
        " 0px rgba(0, 0, 0, " +
        (formObj.buttonshadowopacity
            ? formObj.buttonshadowopacity / 100
            : "0.3") +
        ")");
}
...
function t_zeroForms__generateBtnStyles(btn, recid, formID, formObj, zeroForm) {
    var btnFontFamily,
        buttonStyles = t_zeroForms__generateButtonStyles(
            formObj,
            window.getComputedStyle(btn).fontFamily
        ),
    ...
    "published" !== window.tildamode &&
    (baseSelector = '[data-elem-id="' + formID + '"] ');
    ...
    btnStyles &&
    btnStyles.parentElement &&
    btnStyles.parentElement.removeChild(btnStyles),
        t_zeroForms__setScriptOrStyle(
            btnStylesID,
            "",
            styleValue,
...
function t_zeroForms__generateButtonStyles(formObj, btnFontFamily) {
    var buttonStyles = {
            ...
            border: formObj.buttonbordersize
                ? formObj.buttonbordersize +
                "px solid " +
                (formObj.buttonbordercolor || "transparent")
                : "",
...
function t_zeroForms__createErrorBox(formObj, direction) {
    ...
    textWrapper.classList.add("t-form__errorbox-text"),
        ...
        ["all", "req", "email", "name", "phone", "string"].forEach(function (
            field
        ) {
            ...
            "all" !== field &&
            "string" !== field &&
            (text.textContent = formObj["formerr" + field]),
    ...
    return (
        errorBoxCloseBtn.classList.add("tn-form__errorbox-close"),
            ...
            errorBoxCloseBtn.insertAdjacentElement(
                "beforeend",
...
function t_zeroForms__getBottomText(formID, formObj, recid, zeroForm) {
    ...
    if (
        ...
        formObj.inputtitlecolor && (label.style.color = formObj.inputtitlecolor);
        var input = document.createElement("input"),
            inputPreferences;
        t_zeroForms__appendMainSettingToField(
            input,
        ...
        labelText.classList.add("t-checkbox__labeltext"),
            ...
            label.insertAdjacentElement("beforeend", labelText);
        var selector = t_zeroForms__createSelector(
                recid,
                formID,
                ".t-form__bottom-text .t-checkbox__indicator:after"
            ),
            styles = formObj.inputelscolor
                ? "color: " + formObj.inputelscolor + ";"
                : "";
        return (
            t_zeroForms__setScriptOrStyle(
                "t-zero-form-btn-styles-" + formID,
                "",
                selector + "{" + (styles += "left:3px;top:0;height:6px;") + "}",
                "style",
                zeroForm
            ),
                label
...
function t_zeroForms__animateInputs(zeroForm, formObj, recid, formID) {
    ...
    ((styles += mainSelector + ".t-input__vis-ph"),
        ...
        t_zeroForms__setScriptOrStyle(
            "t-zero-form-anim-styles-" + recid + "-" + formID,
            "",
            styles,
            "style",
            zeroForm
    ...
    var topOffset =
            (Number(formObj.inputheight) - Number(formObj.inputfontsize)) / 2,
        fontWeight =
            "variation" === formObj.inputfontweight
                ? formObj.inputvariationweight
                : formObj.inputfontweight,
    ...
    if (
        (Array.prototype.slice
            ...
            .forEach(function (input) {
                ...
                if (placeholder) {
                    ...
                    formObj.inputfontsize &&
                    ((animField.style.fontSize = formObj.inputfontsize + "px"),
                        (animField.style.height =
                            parseInt(formObj.inputfontsize, 10) + 1 + "px")),
        ...
        var textareaNotBBOnly = zeroForm.querySelectorAll(
                "textarea:not(.t-input_bbonly)"
            ),
...
function t_zeroForms__appendAttributes(input, inputPreferences) {
    inputPreferences.secondaryClassName &&
    input.classList.add(inputPreferences.secondaryClassName),
    inputPreferences.placeholder &&
    (input.placeholder = inputPreferences.placeholder),
    inputPreferences.require && input.setAttribute("data-tilda-req", "1");
}

function t_zeroForms__appendStylesToField(input, inputStyles) {
    for (var k in (input.classList.contains("t-input-inline-styles") ||
    input.classList.add("t-input-inline-styles"),
        inputStyles))
        input.style[k] = inputStyles[k];
    if (input.classList.contains("t-input-phonemask__wrap")) {
        var phoneMaskSelect = input.querySelector(
            ".t-input-phonemask__select-code"
        );
        phoneMaskSelect && (phoneMaskSelect.style.fontSize = inputStyles.fontSize),
        phoneMaskSelect &&
        (phoneMaskSelect.style.fontWeight = inputStyles.fontWeight);
        var phoneMaskInput = input.querySelector(".t-input-phonemask");
        phoneMaskInput && (phoneMaskInput.style.fontSize = inputStyles.fontSize),
        phoneMaskInput &&
        (phoneMaskInput.style.fontWeight = inputStyles.fontWeight);
    }
}
...
function t_zeroForms__setIndicatorStyles(recid, formID, color, type, field) {
    if (color && field) {
        ...
        (styles.textContent =
            mainSelector + "{" + currentStyle + ":" + color + ";}"),
            field.appendChild(styles);
    }
}

function t_zeroForms__createInputPlaceholderStyles(
    formID,
    formObj,
    recid,
    zeroForm
    ...
    (recid = (recid = zeroForm.closest(".r")
        ...
        : "").replace("rec", "")),
        t_zeroForms__setScriptOrStyle(
            "t-zero-placeholder-" + recid + "-" + formID,
            "",
            styles,
            "style",
            zeroForm
...
function t_zeroForms__setScriptOrStyle(id, path, content, type, zeroForm) {
    if (!document.getElementById(id)) {
        ...
        var atomEl =
                "style" === type && zeroForm
                    ? zeroForm.querySelector(".tn-atom")
                    : null,
            appendParent;
        ("style" === type && atomEl ? atomEl : document.body).insertAdjacentElement(
            "beforeend",
            element
        );
    }
...
function t_zeroForms__createLabel(type, labelStyles, formObj) {
    ...
    return (
        ...
        formObj &&
        formObj.inputtitlecolor &&
        (label.style.color = formObj.inputtitlecolor),
        formObj &&
        formObj.inputfontfamily &&
...
function t_zeroForms__createNameFieldForCheckbox(
    inputPreferences,
    wrapper,
    type
) {
    ...
    return (
        t_zeroForms__appendMainSettingToField(
            ...
            inputPreferences,
            "hidden",
            "t-" + type + "__hiddeninput"
        ),
            (hiddenInput.tabIndex = -1),
        inputPreferences.require && hiddenInput.setAttribute("data-tilda-req", "1"),
            hiddenInput
    );
}
...
function t_zeroForms__createHiddenField(value, name, fieldClass) {
    ...
    return (
        ...
        fieldClass && input.classList.add(fieldClass),
            input
    );
}
...
function t_zeroForms__appendMainSettingToField(
    input,
    inputPreferences,
    type,
    supportClassList
    ...
    ("object" == typeof supportClassList
        ...
        : "string" == typeof supportClassList &&
...
function t_zeroForms__initInputStyles(formObj, inputFontWeight) {
    var inputStyles = {
            ...
            border: formObj.inputbordersize
                ? formObj.inputbordersize + "px solid " + formObj.inputbordercolor ||
                "#000"
                : "",
...
function t_zeroForms__setTitleStyles(textEl, titleStyles, titleFontWeight) {
    ...
    (textEl.style.color = titleStyles.color || ""),
        ...
        (textEl.style.paddingBottom = titleStyles.paddingBottom
            ? titleStyles.paddingBottom + "px"
            : ""),
    isTitle &&
    (textEl.style.fontSize = titleStyles.fontSize
...
function t_zeroForms__isFormOutside(form) {
    ...
    var formPos = form.getBoundingClientRect(),
        artBoardPos = artBoard.getBoundingClientRect();
    if (formPos.right < 0) return !0;
    var overflowValue =
            !!artBoard && artBoard.getAttribute("data-artboard-ovrflw"),
        isOverflowNotHidden;
    if ("auto" === overflowValue || "visible" === overflowValue) return !1;
    if (formPos.left > artBoardPos.right + window.pageXOffset) return !0;
    var isScaled =
        artBoard && artBoard.classList.contains("t396__artboard_scale");
    isScaled ||
    (isScaled =
        "window" ===
        t_zeroForms__getFieldValue(artBoard, "data-artboard", "upscale"));
    var formTopPos = formPos.top,
        artBoardTopPos = Math.floor(artBoardPos.top + window.pageYOffset),
        artBoardBottomPos = Math.floor(artBoardPos.bottom + window.pageYOffset),
        isOnlyScalable;
    isScaled &&
    (Boolean(
    ...
    return (
        (formTopPos += window.pageYOffset) > artBoardBottomPos ||
        formTopPos < artBoardTopPos
    );
}
...
function t_zeroForms__getFieldValue(element, attrName, prop) {
    if (element) {
        var rec = element.closest(".r"),
            recid,
            artBoardId = "ab" + (rec ? rec.id.replace("rec", "") : ""),
            dataField,
            resolution,
            breakpoints = [];
        if (void 0 !== window.tn) {
            void 0 !== window.tn[artBoardId]
                ? ((resolution = window.tn[artBoardId].curResolution),
                    (breakpoints = window.tn[artBoardId].screens.slice().reverse()))
                : ((resolution = window.tn.curResolution),
                    (breakpoints =
                        void 0 !== window.tn.screens
                            ? window.tn.screens.slice().reverse()
                            : [1200, 960, 640, 480, 320]));
            var postfix = "data-field" === attrName ? "-value" : "";
            return (
                breakpoints.forEach(function (breakpoint, i) {
                    if (
                        ...
                        (dataField = element.getAttribute(
                            attrName + "-" + prop + postfix
                        )),
                        i > 0 && +resolution === breakpoint)
                    ) {
                        if (
                            ((dataField = element.getAttribute(
                                attrName + "-" + prop + "-res-" + breakpoint + postfix
                            )),
                            i > 1 && !dataField)
                        )
                            for (
                                var slicedBreakpoints = breakpoints.slice(1, i),
                                    n = slicedBreakpoints.length - 1;
                                n >= 0 &&
                                !(dataField = element.getAttribute(
                                    attrName +
                                    "-" +
...
function t_zeroForms__createSelector(recid, formID, selector) {
    var style = "published" === window.tildamode ? "#rec" + recid + " " : "";
    return (
        (style += '[data-elem-id="' + formID + '"]'), (style += " " + selector)
    );
}
...
function t_zeroForms__fromObjToArray(object) {
    ...
    if (!isSupportedObjValues)
        for (var k in object) arrayOfOptions.push(object[k]);
    return arrayOfOptions;
}

function t_zeroForms__updateCheckboxesValues() {
    var inputWrapper = this.closest("[data-input-lid]"),
        checkedCheckboxes = Array.prototype.slice.call(
            inputWrapper.querySelectorAll(".t-checkbox:checked")
        ),
        value = "";
...
function t_zeroForms__initQuanityClickCount(e) {
    ...
    if (quantityBtn) {
        var currentParent,
            currentInput = quantityBtn
                .closest("[data-input-lid]")
                .querySelector(".t-inputquantity"),
...
function t_zeroForms__onRender(form, modeChecked, callback) {
    (("edit" !== window.tildamode && "zero" !== window.tildamode) ||
        !modeChecked) &&
    t_zeroForms__onReady(function () {
        form.classList.contains("zero-form-rendered")
            ? callback()
            : form.addEventListener("render", callback);
    });
}
...
function t_zeroForms__createFormObj(zeroForm) {
    ...
    return (
        [
            ...
            formObj[field] = t_zeroForms__getFieldValue(
                zeroForm,
                "data-field",
                field
            );
    ...
    if ("function" == typeof window[funcName]) okFunc();
        ...
        setTimeout(function checkFuncExist() {
            ...
            "function" != typeof window[funcName]
                ...
                "function" != typeof window[funcName] &&
                console.warn(funcName + " is undefined"),
