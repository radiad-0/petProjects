...
(window.browserLang = (
  ...
  t_onReady(function () {
    ...
    if (
      ...
      for (
        var a = Array.prototype.slice.call(e).filter(function (t) {
            return (
        ...
        var o,
          r = (o = a[n]).getBoundingClientRect().top + window.pageYOffset,
          l = window.pageYOffset + window.innerHeight + 300;
        t_addClass(o, r > 1e3 && r > l ? "r_hidden" : "r_showed"),
          t_addClass(o, "r_anim");
      }
      if (a.length) {
        function d() {
          for (var t = a.length - 1; t >= 0; t--) {
            ...
            e.getBoundingClientRect().top + window.pageYOffset <
              ...
              (a = Array.prototype.slice.call(a)).splice(t, 1));
          }
        }
    ...
    var u = document.querySelector(".t-tildalabel"),
      m;
    (m = c
      ? Math.max(c.scrollHeight, c.offsetHeight, c.clientHeight, s.offsetHeight)
      : s.offsetHeight) +
      70 <
    window.innerHeight
      ? u && (u.style.display = "none")
      : u && u.setAttribute("style", "display: block !important");
  }),
  (function () {
    function t() {
  ...
  (function () {
    ...
    function e() {
      for (
        ...
        if ((i = (o = t[n]).style).height.indexOf("vh") > -1) {
          ...
          c && (c.style.height = d), u && (u.style.height = d), (i.height = d);
        }
      }
      ...
      for (var n = 0; n < m.length; n++) {
        ...
        (i = (o = m[n]).style).height.indexOf("vh") > -1 &&
          ((e = parseInt(i.height) / 100), (d = p + "px"), (i.height = d));
      }
    }
    function n() {
    ...
    function o(t) {
      for (
        ...
        if (i) {
          var a = "rem" === o.getAttribute("data-auto-correct-font-size"),
            r;
          if (document.documentElement.clientWidth > t)
            (r = (r = i.replace("lineheight", "line-height")).replace(
              "fontsize",
              "font-size"
            )),
            ...
            if (parseInt(getComputedStyle(o).fontSize.replace("px", "")) < 30)
              continue;
            (r = i.replace("line-height", "lineheight")),
              (r = a
                ? r.replace(/font-size.*px;/gi, "font-size: 1.6rem;")
                : r.replace("font-size", "fontsize")),
              o.setAttribute("style", r);
          }
        }
      }
