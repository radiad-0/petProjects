(window.Tilda = window.Tilda || {}),
  (function () {
    function e() {
      ...
      var o = document.querySelectorAll("input.js-amount");
    ...
    (Tilda.sendEcommerceEvent = function (e, t) {
      ...
      for (
        ...
        a > "" && (a += ", "),
          ...
          void 0 !== o.options &&
            o.options.length > 0 &&
            Array.prototype.forEach.call(o.options, function (e) {
              c += e.option + ": " + e.variant + "; ";
            });
        var s = { name: o.name, price: o.price, variant: c, quantity: 1 };
        o.id && o.id > 0 && ((id = o.id), (s.id = o.id)),
          o.uid && o.uid > 0 && ((m = o.uid), (s.uid = o.uid)),
          o.recid && o.recid > 0 && ((n = o.recid), (s.recid = o.recid)),
          o.lid && o.lid > 0 && ((l = o.lid), (s.lid = o.lid)),
          o.sku && o.sku > 0 && (s.sku = o.sku),
          (d[d.length] = s);
      }
      var s;
      ("add" !== e && "remove" !== e) ||
        ...
        ((s = { ecommerce: {} }).ecommerce[e] = { products: d }),
        Tilda.sendEventToStatistics(r, a, s, i);
    }),
        ...
        (c = document.getElementById("allrecords")) &&
          (o =
            null !== c.getAttribute("data-fb-event")
              ...
              : window.jQuery && void 0 !== $("#allrecords").data("fb-event")
        ...
        c &&
          (m =
            null !== c.getAttribute("data-vk-event")
              ...
              : window.jQuery && void 0 !== $("#allrecords").data("vk-event")
              ? $("#allrecords").data("vk-event")
              : null);
        var l = !(!m || "nosend" !== m),
          u = "",
          s = document.querySelector(".t706");
        if (
          ((u = c.getAttribute("data-tilda-currency")
            ? c.getAttribute("data-tilda-currency")
            : s && s.getAttribute("data-project-currency-code")
            ? s.getAttribute("data-project-currency-code")
            : "RUB"),
          ...
          if (window.gtagTrackerID && "gtag" === window.mainTracker)
            if (i)
              if (r && r.event)
                if ("purchase" === r.event) {
                  for (
                    var d = r.ecommerce.purchase.products, w = 0, g = 0;
                    g < d.length;
                    g++
                  )
                    if ("delivery" === d[g].id) {
        ...
        try {
          ...
          if (
            ...
            var a,
              i = t.split("&");
            for (var d in i)
              "amp;" === (a = i[d].split("="))[0].substring(0, 4) &&
                (a[0] = a[0].substring(4)),
                "utm_" === a[0].substring(0, 4) && (r = r + i[d] + "|||");
            if (r.length > 0) {
              var c = new Date();
