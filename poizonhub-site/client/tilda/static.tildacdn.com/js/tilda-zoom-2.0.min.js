...
function t_zoom__addingImgsIntoCarousel(t) {
  ...
  var a = document.querySelector(".t-carousel__zoomer__track"),
    i = "y" === window.lazy;
  Array.prototype.forEach.call(o, function (t, e) {
    ...
    if (
      (("IMG" !== t.nodeName && "DIV" !== t.nodeName) ||
        ...
        (l = t.getAttribute("data-img-zoom-descr") || "")),
      n)
    ) {
      var s = document.createElement("div");
      s.classList.add("t-zoomer__title"),
        s.classList.add("t-name"),
        s.classList.add("t-descr_xxs"),
        (s.textContent = n);
    }
    if (l) {
      var _ = document.createElement("div");
      _.classList.add("t-zoomer__descr"),
        _.classList.add("t-descr"),
        _.classList.add("t-descr_xxs"),
        (_.textContent = l);
    }
    var d = document.createElement("div");
    d.classList.add("t-carousel__zoomer__item");
    var m = document.createElement("div");
    m.classList.add("t-carousel__zoomer__wrapper");
    var u = document.createElement("img");
    if (
      (u.classList.add("t-carousel__zoomer__img"),
      i
        ? (u.classList.add("t-img"),
          u.setAttribute("data-original", c),
          (0 !== e && e !== o.length - 1) ||
            u.setAttribute("data-lazy-rule", "skip"))
        : (u.src = c),
      d.appendChild(m),
      m.appendChild(u),
      n || l || window.t_zoom__isMobile)
    ) {
...
function t_zoom__createAndLoopSlider(t) {
  ...
  if (o && r.length) {
    ...
    if (window.t_zoom__isMobile) {
      var a = Array.prototype.reduce.call(
        r,
        function (t, e) {
...
function t_zoom_fetchSVG(t, e, o) {
  ...
  fetch(r)
    ...
    .then(function (r) {
      ...
      t.setAttribute("data-original-svg-height", a.getBBox().height.toString()),
        t.setAttribute("data-original-svg-width", a.getBBox().width.toString()),
        (t.style.width = a.getBBox().width + "px"),
        (t.style.height = a.getBBox().height + "px"),
        e < a.getBBox().height || o < a.getBBox().width
          ? (!window.isDoubletapScaleAdded &&
              window.t_zoom__isMobile &&
              t_zoom_doubletapScaleInit(),
            t_zoom_scale_init())
...
function t_zoom_setModalColor(t) {
  ...
  var i = document.querySelector(".t-zoomer__container"),
    ...
    u = "black" === t_zoom_luma_rgb(n) ? "#000000" : "#ffffff";
  "#000000" === u
    ? ((_ = "#ffffff"),
      (d = "rgba(1, 1, 1, 0.3)"),
...
function t_zoom_luma_rgb(t) {
  ...
  return o.length < 3
    ? "black"
    : 0.2126 * o[0] + 0.7152 * o[1] + 0.0722 * o[2] < 128
    ? "black"
    : "white";
}
