...
function t754_removeSizeStyles(styleStr) {
  if (
    styleStr &&
    (styleStr.indexOf("font-size") !== -1 ||
      styleStr.indexOf("padding-top") !== -1 ||
      styleStr.indexOf("padding-bottom") !== -1)
  ) {
    var styleStrSplitted = styleStr.split(";");
    styleStr = "";
    for (var i = 0; i < styleStrSplitted.length; i++) {
      if (
        styleStrSplitted[i].indexOf("font-size") !== -1 ||
        styleStrSplitted[i].indexOf("padding-top") !== -1 ||
        styleStrSplitted[i].indexOf("padding-bottom") !== -1
      ) {
...
function t754_copyTypography(recid) {
  ...
  var popupDescription = rec.querySelectorAll(
    ".t-popup .t754__descr, .t-popup .t754__text"
  );
