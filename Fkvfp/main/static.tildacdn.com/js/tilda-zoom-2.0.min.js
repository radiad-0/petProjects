...
function t_zoom__createCloseBtn() {
  ...
  return (
    t.insertAdjacentHTML(
      "beforeend",
      '<svg width="20" height="20" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.41421 -0.000151038L0 1.41406L21.2132 22.6273L22.6274 21.2131L1.41421 -0.000151038Z" fill="black"/><path d="M22.6291 1.41421L21.2148 0L0.00164068 21.2132L1.41585 22.6274L22.6291 1.41421Z" fill="black"/></svg>'
    ),
    t
  );
}
...
function t_zoomHandler(t) {
  ...
  var e = document.querySelector(".t-zoomer__container"),
    ...
    a =
      ...
      document.createElement("div")),
    a =
      (a.classList.add("t-carousel__zoomer__track"),
      n.appendChild(a),
    ...
    a =
      ...
      e && e.appendChild(o),
      t.closest(".r"));
  if (!document.querySelector(".t-carousel__zoomer__track") || !a) return !1;
  t_zoom__addingImgsIntoCarousel(t);
  i = document.querySelector(".t-zoomer__close");
  i && (i.style.display = "flex"),
    t_zoom_setModalColor(a),
    ...
    t_zoom_checkForScale(),
    t_zoom_lockScroll(),
    window.t_zoom__isMobile && (t_zoom_initSwipe(), t_zoom_initCloseSwipe()),
...
function t_zoom_initSwipe() {
  var t,
    n,
    i,
    l = document.querySelectorAll(".t-carousel__zoomer__item"),
    ...
    window.tzoomopenonce ||
      ...
      t.on("panmove", function (t) {
        ...
        "y" === o ||
          ...
          1 !== t.maxPointers ||
          i ||
          (40 < Math.abs(t.deltaX) && e.setAttribute("data-on-drag", "y"),
          n &&
            ((o = n + t.deltaX),
      ...
      t.on("panend", function (t) {
        var e,
          ...
          n =
            ...
            r.getAttribute("data-on-transition")),
          a = c.getAttribute("data-on-drag");
        "y" === n ||
          "y" === a ||
          1 !== t.maxPointers ||
          i ||
          ...
          0.6 < (o = (o - Math.abs(a + e)) / n / 1e3)
            ? (o = 0.6)
            : o < 0.2 && (o = 0.2),
          (r.style.transitionDuration = o + "s"),
          t.velocityX < -0.5 || t.deltaX < -80
            ? (t_zoom_unscale(),
              t_zoom_showSlide("next"),
              t_zoom_checkForScale())
            : 0.5 < t.velocityX || 80 < t.deltaX
            ? (t_zoom_unscale(),
...
function t_zoom__initSingleZoom() {
  var t;
  1 === document.querySelectorAll(".t-carousel__zoomer__item").length &&
...
function t_zoom__addingImgsIntoCarousel(t) {
  var e = t.closest(".r"),
    s = e
      ...
      : [],
    _ =
      ((e ? e.querySelector(".t-slds") : null) &&
        ((e = t.closest(".t-slds")) &&
          (s = e.querySelectorAll(".t-zoomable:not(.t-slds__thumbs_gallery)")),
        e &&
          e.querySelector(".tn-elem__gallery__video-wrapper") &&
  ...
  Array.prototype.forEach.call(s, function (t, e) {
    var o,
      r,
      n = t.getAttribute("data-img-zoom-url"),
      a = "",
      i = "",
      n = n ? n.split(",") : "",
      t =
    ...
    c.classList.add("t-carousel__zoomer__img"),
      d
        ? (c.classList.add("t-img"),
          ...
          (0 !== e && e !== s.length - 1) || (c.src = n))
        : (c.src = n),
      t.appendChild(l),
      l.appendChild(c),
      (a || i || window.t_zoom__isMobile) &&
  ...
  o &&
    ...
    Array.prototype.forEach.call(r, function (t) {
      var e = t.querySelector(".t-carousel__zoomer__img"),
        o = e.getAttribute(i ? "data-original" : "src"),
        t = t.querySelector(".t-zoomer__comments"),
        r = t ? t.offsetHeight : 0,
        t =
          (window.t_zoom__isMobile && (r = a),
          t && (t.style.height = r + "px"),
          (e.style.maxHeight =
            document.documentElement.clientHeight - (r + n) + "px"),
          o &&
            -1 !== o.indexOf(".svg") &&
    ...
    (t = (r = (o = t.getAttribute("data-img-zoom-url"))
      ...
      : null)
      ? r.closest(".t-carousel__zoomer__item")
      : null) &&
      ((o = !!t && t.offsetLeft),
...
function t_zoom_showSlide(t) {
  var e = document.querySelector(".t-carousel__zoomer__track"),
    ...
    t =
      ...
      ("next" !== t && "prev" !== t) ||
        ((n = ("next" === t ? n + 1 : o.length + (n - 1)) % o.length),
...
function t_zoom_initCloseSwipe() {
  ...
  t.on("panstart", function () {
    ...
    t.on("panmove", function (t) {
      ...
      ("y" === n.getAttribute("data-on-drag") &&
        "y" !== r.getAttribute("data-on-drag")) ||
        !(
          (-120 < t.angle && t.angle < -60) ||
          (t.angle < 120 && 60 < t.angle)
        ) ||
        1 !== t.maxPointers ||
        a ||
        (40 < e && r.setAttribute("data-on-drag", "y"),
        (e = o + t.deltaY),
...
function t_zoom__waitImgForScale(t, e, o) {
  t.src && t.naturalWidth && t.naturalHeight
    ? o()
    : Date.now() - e < 3e3
    ? setTimeout(function () {
...
function t_zoom_checkToScaleInit(t) {
  ...
  -1 === t.src.indexOf(".svg") || window.isIE || n
    ? o < t.naturalHeight || e < t.naturalWidth
    ...
    .then(function (t) {
      var e = document.createElement("div"),
        t =
          ...
          (e.innerHTML = t),
          e.querySelector("svg"));
      o.setAttribute("data-original-svg-height", t.getBBox().height.toString()),
        o.setAttribute("data-original-svg-width", t.getBBox().width.toString()),
        (o.style.width = t.getBBox().width + "px"),
        (o.style.height = t.getBBox().height + "px"),
        r < t.getBBox().height || n < t.getBBox().width
          ? (!window.isDoubletapScaleAdded &&
              window.t_zoom__isMobile &&
              t_zoom_doubletapScaleInit(),
            t_zoom_scale_init())
...
function t_zoom_scale_init() {
  ...
  (t.style.display = "block"),
    "y" !== t.getAttribute("data-zoom-scale-init") &&
      ...
      a.addEventListener(
        ...
        function (t) {
          var e = document.querySelector(
            ...
            n = !a.classList.contains("zoomer-no-scale");
          ((window.t_zoom__isMobile &&
            t.target.closest(".t-zoomer__scale") &&
            n) ||
            (!window.t_zoom__isMobile &&
              n &&
              !t.target.closest(
            ...
            (e.style.maxHeight = ""),
            a.classList.contains("scale-active")
              ? t_zoom_unscale()
...
function t_zoom_doubletapScaleInit() {
  ...
  new Hammer(r, {
    ...
    2 === t.tapCount &&
      document.body.classList.contains("t-zoomer__show") &&
      !t.target.closest(".t-carousel__zoomer__control") &&
      ...
      (o.style.transition = "none"),
      (o.style.transform = "none"),
      r.classList.contains("scale-active")
        ? t_zoom_unscale()
        : (r.classList.add("scale-active"),
...
function t_zoom_desktopZoomPositioningInit(e, t) {
  ...
  function _(t, e) {
    (n =
      (100 * (void 0 !== t.touches ? t.touches[0] : t).clientX) /
      window.innerWidth),
      (a = -(n * (e.offsetWidth - window.innerWidth)) / 100),
      (e.style.left = a + "px");
  }
  function d(t, e) {
    (o =
      (100 * (void 0 !== t.touches ? t.touches[0] : t).clientY) /
      window.innerHeight),
...
function t_zoom_mobileZoomPositioningInit(o) {
  var r = (window.innerWidth - o.offsetWidth) / 2,
    ...
    a = ((o.style.left = r + "px"), (o.style.top = n + "px"), { x: 0, y: 0 }),
    i = {},
    l = {};
...
function t_zoom_unscale() {
  ...
  r &&
    ((e = r.querySelector(".t-carousel__zoomer__img")),
    (t = r.querySelector(".t-zoomer__comments")),
    a &&
      ((a = a.offsetHeight - r.offsetHeight),
      ...
      (e.style.left = ""),
      (e.style.top = ""),
      (e.style.maxHeight = "calc(100vh - " + (a + t) + "px)"))),
    void 0 !== r.offsetLeft &&
      void 0 !== r.offsetTop &&
      ((e = r.offsetLeft), (n.style.transform = "translateX(" + -e + "px)")),
    o.length && n.setAttribute("data-cached-zoom", "y"),
    setTimeout(function () {
      n.style.transition = "";
    }, 100);
}
...
function t_zoom_setModalColor(t) {
  var e,
    ...
    r = "#ffffff",
    n = "#000000",
    a = t.getAttribute("data-bg-color"),
    a = t_zoom_hexToRgb((a = a || r)),
    t =
      ...
      document.querySelector(".t-zoomer__container")),
    i = document.querySelectorAll(".t-zoomer__wrapper svg"),
...
function t_zoom_luma_rgb(t) {
  ...
  return e.length < 3 || 0.2126 * e[0] + 0.7152 * e[1] + 0.0722 * e[2] < 128
    ? "black"
    : "white";
}
