    ...
    if (
      (p ||
        (window.tildamode && "zero" === window.tildamode
          ? (p = a.querySelector(
              '.tn-artboard [data-input-lid="' + t + '"]'
            )) || (p = a.querySelector(".tn-artboard"))
          : (p = document.querySelector('[data-input-lid="' + t + '"]')) ||
            (p = document.body)),
      ...
      if (o) {
        ...
        t_form_phonemask__addCurrentStyle(p),
          (p.querySelector(".t-input-phonemask__options-wrap").innerHTML =
            t_form_phonemask__getDrawSelector(i)),
...
function t_form_phonemask__initSelectEvents(e, t, n) {
  ...
  function l() {
    i.classList.contains("t-input-phonemask__options-wrap_open")
      ? x()
      : (x(), i.classList.add("t-input-phonemask__options-wrap_open")),
      1 === a.length && (a[0].style.overflow = "unset");
  }
  function x() {
  ...
  function u() {
    var e = this,
      ...
      a;
    ("(" !== n && n) ||
      ((this.value = ""), (t.querySelector(".js-phonemask-result").value = "")),
  ...
  function _(e) {
    ...
    if (t) {
      var a = /[-[\]/{}()*+?.\\^$|]/g,
        ...
        o = [];
      if (
        (p && p.classList.remove("t-input-phonemask__options-item_chosen"),
        (e.keyCode >= 48 && e.keyCode <= 57) ||
          (e.keyCode >= 96 && e.keyCode <= 105))
      )
        for (var i in ((s = (s += e.key).replace(a, "\\$&")), n))
...
function t_form_phonemask__copypasteHandling(e, t) {
  ...
  return (
    "object" == typeof a &&
      ...
      (n = a
        .splice(e.getAttribute("data-phonemask-code").match(/[0-9]/g).length)
        .join("")),
    n
  );
}
function t_form_phonemask__addNumberMask(e, t) {
  ...
  if (i) {
    for (var s = 0; s < i.length; s++)
      "9" === i[s][0]
        ? ((r += o.slice(0, i[s].length).join("")), o.splice(0, i[s].length))
        : (r += i[s]);
...
function t_form_phonemask__searchCountry(e, t, n, a, p) {
  ...
  if (-1 !== p.search(o)) {
    ...
    var i = e
        .querySelector(".t-input-phonemask__options-item_chosen")
        .getBoundingClientRect().top,
      r = e.getBoundingClientRect().top,
      s = document.body.scrollTop + e.scrollTop;
    e.scrollTop = i - r + s;
  }
}
