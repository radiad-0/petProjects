...
(window.isSearchBot = !1),
  ...
  t_onReady(function () {
    setTimeout(function () {
      ...
      if (
        ...
        for (
          var o = document.body.childNodes, i = [], a = 0;
          a < o.length;
          a++
        ) {
          var r = o[a];
        ...
        for (a = 0; a < i.length; a++)
          -1 !== i[a].nodeValue.indexOf("'t remove this l") &&
            document
    ...
    if (
      ...
      for (var e = document.querySelectorAll(".r"), n = 0; n < e.length; n++) {
        ...
        o &&
          ...
          a.setAttribute("data-animationappear", "off");
      }
      for (
        var i = window.isIE
            ? document.querySelectorAll(
                ".r:not([data-animationappear]):not([data-screen-min]):not([data-screen-max])"
              )
            : document.querySelectorAll(
        ...
        var a,
          r = (a = i[n]).getBoundingClientRect().top + window.pageYOffset,
          l = window.pageYOffset + window.innerHeight + 300;
        t_addClass(a, 1e3 < r && l < r ? "r_hidden" : "r_showed"),
          t_addClass(a, "r_anim");
      }
      function d() {
        if (i.length)
  ...
  (function () {
    ...
    function e() {
      ...
      -1 !== navigator.userAgent.indexOf("Instagram") && (o = screen.width);
  ...
  (function () {
    var p = -1 !== navigator.userAgent.indexOf("Instagram");
    function t() {
      for (
        var t,
          e,
          ...
          o,
          i,
          a = document.querySelectorAll(".t-cover__carrier"),
          r = 0,
          l = 0;
        l < a.length;
        l++
      )
        -1 < (s = (d = a[l]).style).height.indexOf("vh") &&
          ((r = parseInt(s.height, 10) / 100),
          ((n = document.createElement("div")).id = "tempDiv"),
          (n.style.cssText =
            "position:absolute;top:0;left:0;width:100%;height:100vh;visibility:hidden;"),
          document.body.appendChild(n),
          (n = document.getElementById("tempDiv")),
          (t = parseInt(getComputedStyle(n).height.replace("px", ""))),
          t_removeEl(n),
          (e = Math.round(t * r) + "px"),
          (n = d.closest(".t-cover")) &&
            ((o = n.querySelector(".t-cover__filter")),
            (i = n.querySelector(".t-cover__wrapper")),
            (n.style.height = e)),
          o && (o.style.height = e),
          i && (i.style.height = e),
          (s.height = e));
      for (
        var d,
          s,
          c = document.querySelectorAll("[data-height-correct-vh]"),
          u = window.innerHeight,
          l = (r = 0);
        l < c.length;
        l++
      )
        -1 < (s = (d = c[l]).style).height.indexOf("vh") &&
          ((r = parseInt(s.height) / 100), (s.height = e = u + "px"));
    }
    function e() {
      for (
        var t = p ? screen.width : window.innerWidth,
          e =
            (window.isMobile &&
              !p &&
    ...
    function i(t) {
      for (
        ...
        r &&
          ((o = "rem" === a.getAttribute("data-auto-correct-font-size")),
          document.documentElement.clientWidth > t
            ? ((i = (i = r.replace("lineheight", "line-height")).replace(
                "fontsize",
                "font-size"
              )),
              a.setAttribute("style", i))
            : -1 === r.indexOf("font-size") ||
              parseInt(getComputedStyle(a).fontSize.replace("px", "")) < 30 ||
              ((i = r.replace("line-height", "lineheight")),
              (i = o
                ? i.replace(/font-size.*px;/gi, "font-size: 1.6rem;")
                : i.replace("font-size", "fontsize")),
              a.setAttribute("style", i)));
      }
    }
    (window.isMobile || window.parent.isPagePreview) &&
      ...
      window.innerWidth < 480 || (p && screen.width < 480)
        ? (t_onReady(function () {
            for (
              ...
              var o = t[n];
              26 < parseInt(getComputedStyle(o).fontSize.replace("px", "")) &&
        ...
        : (window.innerWidth < 900 || (p && screen.width < 900)) &&
          t_onReady(function () {
            for (
              var t = document.querySelectorAll('[data-customstyle="yes"]'),
                e = document.querySelectorAll(
              ...
              var o = t[n];
              30 < parseInt(getComputedStyle(o).fontSize.replace("px", "")) &&
                ((o.style.fontSize = null), (o.style.lineHeight = null));
            }
            for (n = 0; n < e.length; n++) {
              o = e[n];
            ...
            for (
              ...
              a &&
                ...
                30 < parseInt(getComputedStyle(o).fontSize.replace("px", "")) &&
                ((a = (
                  "rem" === o.getAttribute("data-auto-correct-font-size")
