...
a1 = '<a class="button" href="learn_words_a1.py">show translation</a>'
a2 = '<a class="button" href="learn_words_a2.py">show examples</a>'
a3 = '<a class="button" href="learn_words.py">skip word</a>'
